    ...
    const navHtml = `
        <nav class="custom-navbar fixed-top">
            <div class="container-fluid px-3 px-md-4">
                <div class="d-flex justify-content-between align-items-center" style="height: 5rem;">
                    ...
                    <div class="d-none d-md-flex align-items-center gap-4">
                        ...
                        <button onclick="app.navigate('le-studio')" class="btn btn-link text-decoration-none custom-nav-link d-flex align-items-center gap-2 ${st.view === 'le-studio' ? 'active' : ''}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M12 6h.01"/><path d="M12 10h.01"/><path d="M12 14h.01"/><path d="M16 10h.01"/><path d="M16 14h.01"/><path d="M8 10h.01"/><path d="M8 14h.01"/></svg> Le Studio</button>
            ...
            <div class="d-md-none mobile-menu px-3 py-3 d-flex flex-column gap-2">
                ...
                <button onclick="app.navigate('le-studio')" class="btn mobile-nav-btn d-flex align-items-center gap-3 ${st.view === 'le-studio' ? 'active' : ''}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M12 6h.01"/><path d="M12 10h.01"/><path d="M12 14h.01"/><path d="M16 10h.01"/><path d="M16 14h.01"/><path d="M8 10h.01"/><path d="M8 14h.01"/></svg> Le Studio</button>
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <ul class="list-unstyled small d-flex flex-column gap-1">
                            ...
                            <li><button onclick="app.navigate('le-studio')" class="footer-link"><span class="text-emerald">→</span> Le Studio</button></li>
