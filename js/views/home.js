    ...
    <div class="animate-fade-in">
        <section class="relative h-[80vh] flex items-center justify-center bg-stone-100 overflow-hidden">
            ...
            <div class="relative z-10 text-center px-4 max-w-4xl mx-auto">
                <h1 class="text-5xl md:text-7xl font-light text-stone-800 mb-6 tracking-tight">
                    Retrouvez votre <span class="italic text-emerald-800 font-serif">harmonie</span>
                </h1>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
                    <div class="p-6 rounded-2xl bg-stone-50 border border-stone-100">
                        <div class="w-16 h-16 mx-auto bg-emerald-100 rounded-full flex items-center justify-center text-emerald-700 mb-6">${icons.user}</div>
                        <h3 class="text-xl font-medium text-stone-800 mb-4">Accompagnement Personnalisé</h3>
                        <p class="text-stone-600 font-light">Des cours en petits groupes pour garantir des corrections précises et une progression sécuritaire.</p>
                    </div>
                    <div class="p-6 rounded-2xl bg-stone-50 border border-stone-100">
                        <div class="w-16 h-16 mx-auto bg-emerald-100 rounded-full flex items-center justify-center text-emerald-700 mb-6">
                        ...
                        <h3 class="text-xl font-medium text-stone-800 mb-4">Méthode Authentique</h3>
                        <p class="text-stone-600 font-light">Nous enseignons la méthode classique tout en l'adaptant aux connaissances biomécaniques modernes.</p>
                    </div>
                    <div class="p-6 rounded-2xl bg-stone-50 border border-stone-100">
                        <div class="w-16 h-16 mx-auto bg-emerald-100 rounded-full flex items-center justify-center text-emerald-700 mb-6">${icons.calendar}</div>
                        <h3 class="text-xl font-medium text-stone-800 mb-4">Flexibilité</h3>
                        <p class="text-stone-600 font-light">Un planning varié adapté à tous les emplois du temps, avec un système de réservation simple en ligne.</p>
                    </div>
                </div>
            </div>
        </section>
